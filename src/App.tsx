...
function App() {
  ...
  return (
    <>
      ...
      <footer className="text-black dark:text-white bg-sky-300 dark:bg-sky-500">
        <div className="mx-auto p-5 flex space-x-10 flex-col md:flex-row justify-evenly items-center">
          {/* Texte explicatif */}
          <p className="my-3 md:max-w-md text-center leading-relaxed">
          ...
          <div className="flex space-x-4 justify-center items-center">
            <a href="https://github.com/CarolinePromis" target="_blank" rel="noreferrer" className="w-10 h-10 bg-sky-500 dark:bg-sky-800 hover:bg-gray-600 dark:hover:bg-gray-900 rounded-lg flex items-center justify-center transition-all duration-300">
              <svg className="w-7 h-7 dark:text-white" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12,2A10,10,0,0,0,8.84,21.5c.5.08.66-.23.66-.5V19.31C6.73,19.91,6.14,18,6.14,18A2.69,2.69,0,0,0,5,16.5c-.91-.62.07-.6.07-.6a2.1,2.1,0,0,1,1.53,1,2.15,2.15,0,0,0,2.91.83,2.16,2.16,0,0,1,.63-1.34C8,16.17,5.62,15.31,5.62,11.5a3.87,3.87,0,0,1,1-2.71,3.58,3.58,0,0,1,.1-2.64s.84-.27,2.75,1a9.63,9.63,0,0,1,5,0c1.91-1.29,2.75-1,2.75-1a3.58,3.58,0,0,1,.1,2.64,3.87,3.87,0,0,1,1,2.71c0,3.82-2.34,4.66-4.57,4.91a2.39,2.39,0,0,1,.69,1.85V21c0,.27.16.59.67.5A10,10,0,0,0,12,2Z" />
              </svg>
            </a>

            {/* LinkedIn */}
            <a href="https://www.linkedin.com/in/caroline-promis" target="_blank" rel="noreferrer" className="w-10 h-10 bg-sky-500 dark:bg-sky-800 hover:bg-blue-500 dark:hover:bg-blue-600 rounded-lg flex items-center justify-center transition-all duration-300">
            ...
            {/* Ko-Fi */}
            <a href="https://ko-fi.com/" target="_blank" rel="noreferrer" className="w-10 h-10 bg-sky-500 dark:bg-sky-800 hover:bg-red-500 dark:hover:bg-red-600 rounded-lg flex items-center justify-center transition-all duration-300">
