...
function App() {
  ...
  return (
    <>
      <BrowserRouter>
        <nav className="bg-pink-300 dark:bg-red-900 px-6">
          <div className="flex items-center relative h-16 justify-between">
            ...
            {/* Logo et nom du site */}
            <a href="/caro-crochet/" className="flex items-center">
            ...
            <div className="flex items-center space-x-4">
              ...
              <ThemeContext.Provider value={{ themeClass, setThemeClass }}>
                <button className={themeClass} onClick={onHandleClick}>
                  <svg fill={isDarkMode ? "#fff" : "#000"} viewBox="0 0 32 32" transform="rotate(-45)" strokeLinecap="round" strokeLinejoin="round" width={32} height={32} className="p-1 rounded-full fill-red-950 hover:fill-white hover:bg-pink-500 dark:hover:bg-red-700 dark:fill-white dark:hover:fill-red-950">
      ...
      <footer className="text-black bg-sky-300 dark:bg-sky-800">
        <div className="p-5 flex flex-col md:flex-row justify-evenly items-center">
          {/* Texte explicatif */}
          ...
          <div className="flex items-center space-x-5">
            <a href="https://github.com/CarolinePromis" target="_blank" rel="noreferrer" className="w-10 h-10 bg-sky-500 hover:bg-gray-600 dark:hover:bg-gray-900 rounded-lg flex items-center justify-center ">
            ...
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/in/caroline-promis" target="_blank" rel="noreferrer" className="w-10 h-10 bg-sky-500 hover:bg-blue-500 dark:hover:bg-blue-600 rounded-lg flex items-center justify-center ">
            ...
            {/* Ko-Fi */}
            <a href="https://ko-fi.com/" target="_blank" rel="noreferrer" className="w-10 h-10 bg-sky-500 hover:bg-red-500 dark:hover:bg-red-600 rounded-lg flex items-center justify-center ">
